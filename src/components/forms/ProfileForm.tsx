				...
				<form
					...
					<div className='space-y-2'>
						...
						<input
							...
							className='w-full px-4 py-3 rounded-xl bg-gray-50 border border-transparent focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-50/50 outline-none transition-all font-medium text-gray-700'
